...
const url1 =
    "https://static.independent.co.uk/2025/03/17/14/slack-imgs-copy.jpg?quality=75&width=1368&crop=3%3A2%2Csmart&auto=webp";
const url2 = "https://knigogo.top/wp-content/uploads/2018/08/Pola-Goukinz.png";
const url3 =
    "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e5/Michael_Lewis_2009.jpg/250px-Michael_Lewis_2009.jpg";

const authors = [
    {
        name: "Майкл Льюїс",
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e5/Michael_Lewis_2009.jpg/250px-Michael_Lewis_2009.jpg",
    ...
    {
        name: "Пола Гоукінз",
        image: "https://static.independent.co.uk/2025/03/17/14/slack-imgs-copy.jpg?quality=75&width=1368&crop=3%3A2%2Csmart&auto=webp",
        biography:
            "британська письменниця, яка здобула широку популярність після публікації роману «Дівчина у потягу» (2015).",
    },
    {
        name: "Емма Доног'ю",
        image: "https://knigogo.top/wp-content/uploads/2018/08/Pola-Goukinz.png",
        biography:
